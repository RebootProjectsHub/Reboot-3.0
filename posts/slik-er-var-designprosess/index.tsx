...
export const post: Post = {
  slug: "slik-er-var-designprosess",
  title: "Slik er vår designprosess",
  category: "Webdesign",
  date: "30. mars 2025",
  dateISO: "2025-03-30",
  excerpt: "Design har alltid vært i utvikling, men i 2025 merker vi endringene dypere. Kunstig intelligens, automatisering og grensesnitt som tilpasses brukeren i sanntid, har …",
...
<figure><img src="/posts/slik-er-var-designprosess/1.avif" alt="Slik er vår designprosess" loading="lazy" /></figure>
<h2>Fra innsikt til løsning</h2>
<p>I vår designprosess starter veien fra idé til ferdig produkt med innsikt. I dag er ikke brukerstudier lenger forbeholdt slutten av prosjektet – de ligger til grunn for alt annet. Ved å gjennomføre intervjuer, observasjoner og digitale spørreundersøkelser kan vi identifisere hva folk faktisk trenger, ikke bare hva de sier at de vil ha.</p>
...
<p>Mange av våre prosjekter bygger på WordPress, som gir både fleksibilitet og eierskap for kunden samtidig.</p>
<h2>Definering av hva som faktisk skal lages</h2>
...
<p>Slik blir denne fasen ikke bare et forarbeid, men selve stedet der idéene formes, testes og forbedres – lenge før én linje kode skrives.</p>
<h2>Design som opplevelse – når form møter funksjon</h2>
<p>Visuelt design er langt mer enn farger og fonter. Det handler om hvordan mennesker opplever en tjeneste fra første møte til siste interaksjon. I 2025 er ikke design bare et tillegg, det er en integrert del av brukerreisen – og et viktig konkurransefortrinn.</p>
<p>Et godt designsystem bygger på visuelle prinsipper som fungerer på tvers av flater, men også på tvers av menneskelige behov. Fargebruk må ta høyde for nedsatt syn. Typografi må balansere personlighet og lesbarhet. Og ikke minst må alt oppleves konsistent – fra mobil til storskjerm.</p>
...
<p>Men testing alene er ikke nok. Vi må også validere. Det betyr å se på helheten: Har vi laget det rette produktet – ikke bare på riktig måte? Har vi løst det riktige problemet? Har vi bygget noe som folk faktisk vil bruke – og komme tilbake til?</p>
<p>Validering krever blikk for både strategi og detaljer. Vi må vite hva vi ønsket å oppnå – og om vi faktisk traff. Her blir samsvar mellom forretningsmål og brukerbehov avgjørende.</p>
<h2>Fra design til virkelighet</h2>
<p>Når designet er ferdig, begynner et nytt kapittel: implementering. Dette er mer enn bare overlevering – det er en integrasjonsøvelse mellom mennesker, teknologier og prosesser. Mange designteam bygger på etablerte rammeverk som for eksempel Google's <a href="https://en.wikipedia.org/wiki/Material_Design" target="_blank" rel="noopener noreferrer">Material Design</a>, som gir retningslinjer for alt fra fargebruk og typografi til interaksjon og tilgjengelighet.</p>
<p>God implementering handler om samarbeid. Designeren må forstå de tekniske rammene. Utvikleren må forstå de visuelle og funksjonelle prioriteringene. Og begge må dele en felles forståelse for hva løsningen skal være.</p>
...
<p>I dette landskapet er det de teamene som forstår helheten, jobber systematisk og evner å tilpasse seg, som lykkes. Det krever struktur. Det krever nysgjerrighet. Og det krever mot til å la brukeren være med hele veien.</p>`,
}
